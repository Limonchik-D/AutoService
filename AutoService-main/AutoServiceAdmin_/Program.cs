...
namespace AutoServiceAdmin
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            service.LoadClientsFromTxt();
            service.LoadCarsFromTxt();
            service.LoadMechanicsFromTxt();
            service.LoadOrdersFromTxt();
            ...
            while (true)
            {
                ...
                switch (input)
                {
                    ...
                    case "0":
                        service.SaveClientsToTxt();
                        service.SaveCarsToTxt();
                        service.SaveMechanicsToTxt();
                        service.SaveOrdersToTxt();
                        return;
        ...
        // Инициализация тестовых данных (по желанию)
